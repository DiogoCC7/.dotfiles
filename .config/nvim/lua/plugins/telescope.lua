return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>pf", builtin.help_tags, { desc = "[S]earch [H]elp" })
		vim.keymap.set("n", "<leader>pk", builtin.keymaps, { desc = "[S]earch [K]eymaps" })
		vim.keymap.set("n", "<leader>pgt", builtin.git_files, { desc = "[S]arch Git Files" })
		...
		vim.keymap.set("n", "<leader>pth", function()
